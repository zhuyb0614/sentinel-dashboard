...
import com.alibaba.csp.sentinel.dashboard.service.ParamFlowRuleService;
...
public class ParamFlowRuleController {
    ...
    public Result<List<ParamFlowRuleEntity>> apiQueryAllRulesForMachine(HttpServletRequest request,
        ...
        try {
            return Result.ofSuccess(paramFlowRuleService.machineRules(MachineInfo.of(app, ip, port)));
    ...
    public Result<ParamFlowRuleEntity> apiAddParamFlowRule(HttpServletRequest request,
        ...
        entity.toRule().setResource(entity.getResource().trim());
        Date date = new Date();
        entity.setGmtCreate(date);
        entity.setGmtModified(date);
        return paramFlowRuleService.addAllMachineRule(entity);
    }
    ...
    public Result<ParamFlowRuleEntity> apiUpdateParamFlowRule(HttpServletRequest request,
        ...
        ParamFlowRuleEntity oldEntity = paramFlowRuleService.getRepository().findById(id);
        if (oldEntity == null) {
        ...
        entity.setGmtModified(date);
        try {
            entity = paramFlowRuleService.getRepository().save(entity);
            if (entity == null) {
        ...
        if (!paramFlowRuleService.publishRules(entity.getApp(), entity.getIp(), entity.getPort())) {
    ...
    public Result<Long> apiDeleteRule(HttpServletRequest request, @PathVariable("id") Long id) {
        ...
        List<ParamFlowRuleEntity> allRules = paramFlowRuleService.getRepository().findByParentId(oldEntity.getParentId());
        return paramFlowRuleService.deleteAllMachineRule(allRules);
    }
