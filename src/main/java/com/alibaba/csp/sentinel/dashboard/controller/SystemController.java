...
import com.alibaba.csp.sentinel.dashboard.repository.rule.JpaSystemRuleStore;
...
public class SystemController {
    ...
    @Autowired
    private JpaSystemRuleStore jpaRuleStore;
    @Autowired
    private JpaRuleRepositoryAdapter<SystemRuleEntity> repository;
    @PostConstruct
    public void init() {
