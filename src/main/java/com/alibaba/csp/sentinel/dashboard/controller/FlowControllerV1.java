...
import com.alibaba.csp.sentinel.dashboard.service.FlowServiceV1;
...
public class FlowControllerV1 {
    ...
    @Autowired
    private FlowServiceV1 flowServiceV1;
    @Autowired
    ...
    public Result<List<FlowRuleEntity>> apiQueryMachineRules(HttpServletRequest request,
        ...
        try {
            return Result.ofSuccess(flowServiceV1.machineRules(MachineInfo.of(app, ip, port)));
    ...
    public Result<FlowRuleEntity> apiAddFlowRule(HttpServletRequest request, @RequestBody FlowRuleEntity entity) {
        ...
        return flowServiceV1.addAllMachineRule(entity);
    }
    ...
    public Result<FlowRuleEntity> updateIfNotNull(HttpServletRequest request, Long id, String app,
        ...
        FlowRuleEntity entity = flowServiceV1.getRepository().findById(id);
        if (entity == null) {
        ...
        try {
            entity = flowServiceV1.getRepository().save(entity);
            if (entity == null) {
        ...
        if (!flowServiceV1.publishRules(entity.getApp(), entity.getIp(), entity.getPort())) {
    ...
    public Result<Long> delete(HttpServletRequest request, Long id) {
        ...
        FlowRuleEntity oldEntity = flowServiceV1.getRepository().findById(id);
        if (oldEntity == null) {
            return Result.ofSuccess(null);
        }
        authUser.authTarget(oldEntity.getApp(), PrivilegeType.DELETE_RULE);
        List<FlowRuleEntity> rules = flowServiceV1.getRepository().findByParentId(oldEntity.getParentId());
        return flowServiceV1.deleteAllMachineRule(rules);
    }
